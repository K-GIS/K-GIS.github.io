...
/*basemaps*/
    ...
    antw.addTo(map);   // grb_grijs is default basemap
...
/*features*/
    var bib = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/0", bibTemplate, bibIcon, 30)
    overlays["bib"] = bib;

    var cul = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/1", culTemplate, culIcon, 50)
    overlays["cul"] = cul;

    var dis = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/2", disTemplate, disIcon, 30)
    dis.addTo(map);
     overlays["dis"] = dis

    var wc = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/3", wcTemplate, wcIcon, 50)
    overlays["wc"] = wc
    
    var school = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/6", schoolTemplate, schoolIcon, 50)
    overlays["school"] = school

    var police = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/9", policeTemplate, policeIcon, 50)
    overlays["police"] = police
    
    var recyclage = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/ArcGIS/rest/services/Astad/FeatureServer/7", recyclageTemplate, recyclageIcon, 50)
    overlays["recyclage"] = recyclage

    var glas = makeCluster("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/ArcGIS/rest/services/Astad/FeatureServer/8", glasTemplate, glasIcon, 50)
    overlays["glas"] = glas
  ...
  /*polygons*/  
    ...
    var sport = L.esri.featureLayer("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/4", {
    ...
    var park = L.esri.featureLayer("//services1.arcgis.com/inQ6vcoHiLEh0Ty2/arcgis/rest/services/Astad/FeatureServer/5", {
        style: function (feature) {
            return parkStyle;
        },
        onEachFeature: function (feature, layer) {
...
/*	 map.addControl( new L.Control.Search({
       ...
       map.addControl( new L.Control.Search({
         url: '//loc.api.geopunt.be/geolocation/location?c=5&q={s}',
